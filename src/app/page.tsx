...
export default function Home() {
  return <main className="site">
    ...
    <nav className="nav"><div className="container navInner"><Link href="/" className="logo"><span className="logoMark">NT</span><span>Namane Tyres</span></Link><div className="navLinks"><a href="#services">Services</a><a href="#location">Find us</a></div><Link href="/book" className="button buttonPrimary">Request Help</Link></div></nav>
    <section className="hero"><div className="container heroGrid"><div><span className="eyebrow">Tyres · Fitting · Repairs</span><h1>Tyre trouble?<br /><em>Let&apos;s sort it.</em></h1><p>Namane Tyres helps drivers with fitting, punctures, pressure checks, tyre sales, light wash services and roadside assistance in Gaborone.</p><div className="actions"><Link href="/book" className="button buttonPrimary">Request Help</Link><a href="#services" className="button buttonLight">See services</a></div><p className="heroNote">If you are offline, you can still open the app and queue a request on this device.</p></div><div className="heroCard"><div className="tyreMark">🛞</div><strong>Namane Tyres</strong><span>Plot 16739 · Gaborone West Phase 1</span><small>Roadside · Opposite Padre Pio Medical Centre</small></div></div></section>
