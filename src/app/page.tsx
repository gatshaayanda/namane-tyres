...
export default function Home() {
  return <main className="site">
    ...
    <section id="work" className="section workSection"><div className="container"><div className="sectionHead"><span className="kicker">The work</span><h2>Real work, real place.</h2><p>Namane Tyres is a roadside tyre business in Gaborone West Phase 1. These are the people, road and working environment behind the service.</p></div><div className="mediaGrid"><figure className="mediaCard"><img src="/namane-assets/passing-car.jpg" alt="Roadside view near Namane Tyres" loading="lazy" /><figcaption>Roadside location in the neighbourhood.</figcaption></figure><figure className="mediaCard"><video controls preload="metadata" playsInline poster="/namane-assets/work-location.jpg"><source src="/namane-assets/zoom-in-work-on-tyres.mp4" type="video/mp4" />Your browser does not support this video.</video><figcaption>Tyre work at the business.</figcaption></figure></div></div></section>
